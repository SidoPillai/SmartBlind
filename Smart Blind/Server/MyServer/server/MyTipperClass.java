...
public class MyTipperClass {
	...
	public static void main(String[] args) throws Exception {
		...
		// Set inputs
		fb.setVariable("temperature",10);
		fb.setVariable("ambient",12);
		// Evaluate
		fb.evaluate();
		...
		Variable v = fb.getVariable("blind");
		//JFuzzyChart.get().chart(fb);
		// Print ruleSet
	//	System.out.println(fb);
		System.out.println("blind: " + fb.getVariable("blind").getValue());
		System.out.println(fb.getVariable("blind").getMembership("close"));
	...
	//	String s = "IF (temperature IS freezing) AND (ambient IS dark) THEN blind IS close";

	}
	 */
	/*
	 * To update the blind status
	 */
